...
@section('content')
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            ...
            <div class="single-hero-items set-bg" data-setbg="{{asset('public/fontend/img/hero-2.jpg')}}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Bag,kids</span>
                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel">
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('uploads')}}/{{ $sp->hinhsp }}" alt="">
                        ...
                        {{-- <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('public/fontend/img/products/women-2.jpg')}}" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('public/fontend/img/products/women-3.jpg')}}" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('public/fontend/img/products/women-4.jpg')}}" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="product-slider owl-carousel">
                        {{-- <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('public/fontend/img/products/man-1.jpg')}}" alt="">
                                <div class="sale">Sale</div>
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('public/fontend/img/products/man-2.jpg')}}" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        {{-- <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('public/fontend/img/products/man-4.jpg')}}" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="{{asset('public/fontend/img/latest-1.jpg')}}" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="{{asset('public/fontend/img/latest-2.jpg')}}" alt="">
                        <div class="latest-text">
                            <div class="tag-list">
                                <div class="tag-item">
                                    <i class="fa fa-calendar-o"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="{{asset('public/fontend/img/latest-3.jpg')}}" alt="">
                        <div class="latest-text">
                            <div class="tag-list">
                                <div class="tag-item">
                                    <i class="fa fa-calendar-o"></i>
