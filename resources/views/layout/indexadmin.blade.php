    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <form class="form-inline ml-3">
        <div class="input-group input-group-sm">
          <input class="form-control form-control-navbar" type="search" name="search" placeholder="tìm kiếm theo tên" aria-label="Search">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?php echo url('/') ?>" class="brand-link">
          ...
          style="opacity: .8">
          <span class="brand-text font-weight-light">GHEL</span>
        </a>
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
              <a href="<?php echo url('/') ?>" class="d-block">Đức Anh Ghel</a>
            </div>
          </div>
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
              <a href="{{route('dssp')}}" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{route('themtk')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>THÊM TÀI KHOẢN</p>
                </a>
              </li>
              <li class="nav-item">
              <a href="{{route('dstk')}}" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
           ...
           <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{route('themdm')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>THÊM DANH MỤC</p>
                </a>
              </li>
              <li class="nav-item">
              <a href="{{route('dsdm')}}" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
...
@yield('content');
            <!--auto slug js -->
            <script src="{{ asset('public/backend/autoslug/autoslug.js') }}"></script>
          <!-- jQuery -->
